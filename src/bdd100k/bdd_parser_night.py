...
def download_large_night_traffic_lights():
    ...
    # 📂 Αποθήκευση ξεχωριστά στον φάκελο night
    output_folder = (
    ...
    good_images = []
    MIN_BOX_AREA = 1600  # 40x40 pixels ελάχιστο μέγεθος φαναριού
    ...
    for image in data:
        ...
        # 🎯 Φιλτράρισμα: Μόνο Νύχτα και Καθαρός/Συννεφιασμένος καιρός (Όχι ομίχλη/βροχή)
    ...
    print("\n=============================================")
    print("📊 ΣΤΑΤΙΣΤΙΚΑ ΦΙΛΤΡΑΡΙΣΜΑΤΟΣ (ΜΕΓΑΛΑ ΝΥΧΤΕΡΙΝΑ ΦΑΝΑΡΙΑ)")
    print("=============================================")
    print(f"🌙 Βρέθηκαν {len(good_images)} νυχτερινές εικόνες με ΚΟΝΤΙΝΑ/ΜΕΓΑΛΑ φανάρια.")
    print("=============================================\n")
    ...
    if os.path.exists(output_folder):
        print("🧹 Καθαρισμός παλιών αρχείων από τον φάκελο night...")
    ...
    print(f"\n🎯 Έναρξη λήψης των {len(target_images)} επιλεγμένων νυχτερινών εικόνων...")
    ...
    print(f"📂 Κατεβάστηκαν επιτυχώς {success_count} καθαρές νυχτερινές εικόνες.")
